...
import { useReadyToSign } from './use-ready-to-sign';
...
describe('useReadyToSign', () => {
  ...
  it('successfully makes POST request with correct URL and headers', async () => {
    ...
    const { result } = renderHook(() => useReadyToSign(), {
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      `https://lb-signatureapi-dev-cbcbc8dxf4gpevfa.westeurope-01.azurewebsites.net/api/lb/matter/${mockMatterId}/signatory/${mockSignatoryId}/readyToSign`,
  ...
  it('calls onSuccess callback when mutation succeeds', async () => {
    ...
    result.current.sign({ onSuccess: onSuccessMock });
